...
namespace MaximeLEAU\JobeetBundle\Command;
...
class JobeetCleanupCommand extends ContainerAwareCommand {
	...
	{
		$this
		->setName('MaximeLEAU:jobeet:cleanup')
	...
	protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $q = $em->getRepository('MaximeLEAUJobeetBundle:Job')->createQueryBuilder('j')
        ...
        // Remove stale jobs
        $nb = $em->getRepository('MaximeLEAUJobeetBundle:Job')->cleanup($days);
