<?php
namespace MaximeLEAU\JobeetBundle\DataFixtures\ORM;
...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $em)
    {
         ...
         $job_sensio_labs->setCreatedAt(new \DateTime('01-02-2015'));
         $job_sensio_labs->setExpiresAt(new \DateTime('03-03-2015'));
         ...
         $job_extreme_sensio->setLogo('extreme-sensio.jpg');
